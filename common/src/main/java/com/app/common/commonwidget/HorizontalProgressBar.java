...
public class HorizontalProgressBar extends View {
    ...
    private void init() {
        ...
        //view真实的高度
        mViewHeight = tipHeight + triangleHeight+ progressMarginTop ;
    }
...
//        tipPaint = getPaint(tipPaintWidth, progressColor, Paint.Style.FILL);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
//        pRectf.set(getPaddingLeft(), tipHeight + progressMarginTop, getWidth(),tipHeight + progressMarginTop);
//        canvas.drawRoundRect(pRectf, roundRectRadius, roundRectRadius, bgPaint);
...
//                currentProgress,
//                tipHeight + progressMarginTop);
//        canvas.drawRoundRect(mRectf, roundRectRadius, roundRectRadius, progressPaint);
//        canvas.drawLine(getPaddingLeft(),
//                tipHeight + progressMarginTop,
//                currentProgress,
//                tipHeight + progressMarginTop,
//                progressPaint);
    ...
    private void drawBgProgress(Canvas canvas){
        pRectf.left = getPaddingLeft();
        pRectf.right = getWidth();
        pRectf.top = tipHeight + progressMarginTop;
        pRectf.bottom = tipHeight + progressMarginTop + progressHeight;
        canvas.drawRoundRect(pRectf, roundRectRadius, roundRectRadius, bgPaint);
    }

    private void drawProgress(Canvas canvas) {
        mRectf.left = getPaddingLeft();
        mRectf.top = tipHeight + progressMarginTop;
        mRectf.right = currentProgress;
        mRectf.bottom = tipHeight + progressMarginTop + progressHeight;
        canvas.drawRoundRect(mRectf, roundRectRadius, roundRectRadius, progressPaint);
    }
    /**
     * 绘制进度上边提示百分比的view
