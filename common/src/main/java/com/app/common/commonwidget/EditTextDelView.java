...
/**
 * Created by cj on 16/1/5.
 */
public class EditTextDelView extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener,
        TextWatcher {
    /**
     * 删除按钮的引用
     */
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.ic_edt_clear_content);
        }
    ...
    public void setmClearDrawableVisible(boolean visible){
        if (mClearDrawable != null){
...
//            bottomColor.setColor(getResources().getColor(R.color.input_view_loss_focus_line_color));
        ...
        if (isOnFocus) {
            bottomColor.setColor(getResources().getColor(R.color.main_color));
        } else {
//            bottomColor.setColor(getResources().getColor(R.color.input_view_loss_focus_line_color));
        }
        setCompoundDrawables(getCompoundDrawables()[0],
